...
|---|---|---|---|---|
| `ryc-project-init` | first-time initialization and bootstrap | repo structure, README/docs, user goals | all managed state files, `AGENTS.md`, `.gitignore` | routine implementation, normal code review |
